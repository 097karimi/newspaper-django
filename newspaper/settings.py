...
SECRET_KEY = '$9e&4wzx8y#3a8c_bm_+^97mxzc25wm%%t7k_2!!-vlqbb#9=j'
...
INSTALLED_APPS = [
    ...
    # 3rd Party
    'crispy_forms', # Working with forms is a challenge and django-crispy-forms 
                    # makes it easier to write DRY (Don’t-Repeat-Yourself) code.
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], # A single templates directory within newspapar
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# setting for CRISPY_TEMPLATE_PACK , set to bootstrap4
CRISPY_TEMPLATE_PACK = 'bootstrap4'

# Django’s console backend setting which outputs the email 
